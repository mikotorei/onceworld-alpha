...
<div class="grid">
  <label class="pill">vit <input id="base_vit" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="vit" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">spd <input id="base_spd" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="spd" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">atk <input id="base_atk" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="atk" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">int <input id="base_int" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="int" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">def <input id="base_def" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="def" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">mdef <input id="base_mdef" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="mdef" style="font-size:11px;padding:3px 7px;">max</button>
  <label class="pill">luk <input id="base_luk" type="number" min="0" value="0"></label><button type="button" class="chip-btn base-max-btn" data-stat="luk" style="font-size:11px;padding:3px 7px;">max</button>
</div>
